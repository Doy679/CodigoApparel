      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-neutral-400">Decoding style, one piece at a time.</p>
          </div>
        ...
        {filteredProducts.length === 0 && (
          <div className="py-24 text-center">
            <p className="text-sm font-bold uppercase tracking-widest text-neutral-400">No products found in this category.</p>
          </div>
        )}
      </div>
    </div>
