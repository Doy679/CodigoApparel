...
import { Shield, Bell, CreditCard, Globe, Save } from "lucide-react";
    ...
    <div className="space-y-10 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          >
            <h3 className="text-xs font-black uppercase tracking-[0.3em] border-b border-neutral-50 pb-4">
              Store Identity
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input
                  defaultValue="Codigo Street & Culture"
                  className="w-full border-b border-neutral-200 py-3 text-sm font-bold uppercase italic focus:border-black outline-none transition-colors"
                />
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-neutral-400">
                ...
                <input
                  defaultValue="ops@codigo.ph"
                  className="w-full border-b border-neutral-200 py-3 text-sm font-bold focus:border-black outline-none transition-colors"
                />
              </div>
              <div className="md:col-span-2 space-y-2">
                ...
                <textarea
                  rows={4}
                  defaultValue="Authentic apparel for the culture. Rooted in the hustle, grounded by the street."
                  className="w-full border border-neutral-100 p-4 text-sm font-bold uppercase tracking-tight focus:border-black outline-none transition-colors resize-none"
                />
              </div>
            </div>
          </motion.div>
