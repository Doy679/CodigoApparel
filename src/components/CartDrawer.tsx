...
export default function CartDrawer() {
  const { cart, isCartOpen, setIsCartOpen, removeFromCart, updateQuantity, updateItemSize } =
    useCartStore();
                        ...
                        <div className="py-2">
                          {item.selectedSize ? (
                            ...
                            <div className="space-y-2">
                              <p className="text-[8px] font-black text-red-500 uppercase tracking-widest animate-pulse">
