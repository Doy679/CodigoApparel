...
export const products: Product[] = [
  {
    ...
    details: [
      ...
      "High-density Stealth Black stitching",
  ...
  },
  {
    ...
    isNew: true,
    description:
      "Rooted in the hustle, grounded by the street. A deep earth tone for the steady and the solid.",
  ...
  },
  {
    ...
    details: [
      "Premium Corduroy Fabric",
      "High-density white-on-white stitching",
      "Signature oversized fit"
    ],
    additionalImages: [
